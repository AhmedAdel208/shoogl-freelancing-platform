...
export default function ErrorState({ 
  ...
  const _message = message || (isRtl ? "حدث خطأ ما أثناء تحميل البيانات" : "An error occurred while loading data");
  const _retryText = retryText || (isRtl ? "إعادة المحاولة" : "Try Again");

  return (
    <div className={`flex flex-col items-center justify-center p-12 bg-red-500/5 border border-red-500/10 rounded-[40px] text-center animate-in zoom-in duration-700 ${className}`}>
