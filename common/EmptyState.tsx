...
export default function EmptyState({
  ...
  return (
    <div
      className={`flex flex-col items-center justify-center py-24 text-gray-medium font-cairo bg-bg/50 rounded-[40px] border-2 border-dashed border-border/50 animate-in fade-in zoom-in duration-700 ${className}`}
    >
